...
export const metadata = { title: "Briefing Pack Konsultasi" };
 ...
 */
export default async function PrintBriefingPage({
  searchParams,
}: {
  ...
  const [detail, letterhead] = await Promise.all([
    fetchProjectDetail(supabase, user.id, searchParams.project),
