...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="size-4 shrink-0 opacity-60 transition-transform duration-200 [[data-state=open]_&]:rotate-180" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-2xs font-bold uppercase tracking-wider text-muted-foreground", className)}
    {...props}
  />
));
